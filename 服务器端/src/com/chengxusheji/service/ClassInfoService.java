...
public class ClassInfoService {
    ...
    /*按照查询条件分页查询班级信息记录*/
    public ArrayList<ClassInfo> queryClassInfo(String classNumber,String className,String classSpecialFieldNumber,String classBirthDate,int currentPage) throws Exception { 
    	...
    	if(!classSpecialFieldNumber.equals("")) where = where + " and t_classInfo.classSpecialFieldNumber like '%" + classSpecialFieldNumber + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<ClassInfo> queryClassInfo(String classNumber,String className,String classSpecialFieldNumber,String classBirthDate) throws Exception  { 
     	String where = "where 1=1";
    	if(!classNumber.equals("")) where = where + " and t_classInfo.classNumber like '%" + classNumber + "%'";
    	if(!className.equals("")) where = where + " and t_classInfo.className like '%" + className + "%'";
    	if(!classSpecialFieldNumber.equals("")) where = where + " and t_classInfo.classSpecialFieldNumber like '%" + classSpecialFieldNumber + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String classNumber,String className,String classSpecialFieldNumber,String classBirthDate) throws Exception {
     	String where = "where 1=1";
    	if(!classNumber.equals("")) where = where + " and t_classInfo.classNumber like '%" + classNumber + "%'";
    	if(!className.equals("")) where = where + " and t_classInfo.className like '%" + className + "%'";
    	if(!classSpecialFieldNumber.equals("")) where = where + " and t_classInfo.classSpecialFieldNumber like '%" + classSpecialFieldNumber + "%'";
