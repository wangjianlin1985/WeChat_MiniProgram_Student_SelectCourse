...
public class ClassInfoController extends BaseController {
	...
	public void list(String classNumber,String className,String classSpecialFieldNumber,String classBirthDate,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
	...
	public String frontlist(String classNumber,String className,String classSpecialFieldNumber,String classBirthDate,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
	...
	public void OutToExcel(String classNumber,String className,String classSpecialFieldNumber,String classBirthDate, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        if(classNumber == null) classNumber = "";
        if(className == null) className = "";
        if(classSpecialFieldNumber == null) classSpecialFieldNumber = "";
        if(classBirthDate == null) classBirthDate = "";
        ...
        for(int i=0;i<classInfoList.size();i++) {
        	...
        	dataset.add(new String[]{classInfo.getClassNumber(),classInfo.getClassName(),classInfo.getClassSpecialFieldNumber(),classInfo.getClassBirthDate(),classInfo.getClassTeacherCharge(),classInfo.getClassTelephone()});
        }
        /*
