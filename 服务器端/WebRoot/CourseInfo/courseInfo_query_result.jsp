...
<div id="courseInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="courseInfoQueryForm" method="post">
			...
			上课老师：<input class="textbox" type="text" id="teacherObj_teacherNumber_query" name="teacherObj.teacherNumber" style="width: auto"/>
...
<div id="courseInfoEditDiv">
	<form id="courseInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox"  id="courseInfo_teacherObj_teacherNumber_edit" name="courseInfo.teacherObj.teacherNumber" style="width: auto"/>
			</span>
		</div>
		<div>
