...
<jsp:include page="../header.jsp"></jsp:include>
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
 										...
 										<tr>
 											...
 											<td><%=courseInfo.getTeacherObj().getTeacherName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="courseInfoQueryForm" id="courseInfoQueryForm" action="<%=basePath %>CourseInfo/frontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
            	<label for="teacherObj_teacherNumber">上课老师：</label>
                <select id="teacherObj_teacherNumber" name="teacherObj.teacherNumber" class="form-control">
                	<option value="">不限制</option>
	 				...
	 				for(Teacher teacherTemp:teacherList) {
	 					String selected = "";
 					if(teacherObj!=null && teacherObj.getTeacherNumber()!=null && teacherObj.getTeacherNumber().equals(teacherTemp.getTeacherNumber()))
 						selected = "selected";
	 				%>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="courseInfo_teacherObj_teacherNumber_edit" class="col-md-3 text-right">上课老师:</label>
		  	 <div class="col-md-9">
			    <select id="courseInfo_teacherObj_teacherNumber_edit" name="courseInfo.teacherObj.teacherNumber" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
			...
			if (courseInfo) {
				...
				$.ajax({
					...
					success: function(teachers,response,status) { 
						$("#courseInfo_teacherObj_teacherNumber_edit").empty();
						var html="";
		        		$(teachers).each(function(i,teacher){
		        			html += "<option value='" + teacher.teacherNumber + "'>" + teacher.teacherName + "</option>";
		        		});
		        		$("#courseInfo_teacherObj_teacherNumber_edit").html(html);
		        		$("#courseInfo_teacherObj_teacherNumber_edit").val(courseInfo.teacherObjPri);
					}
				});
