...
<%
    ...
    String classSpecialFieldNumber = (String)request.getAttribute("classSpecialFieldNumber"); //所属专业查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
 										...
 										<tr>
 											...
 											<td><%=classInfo.getClassSpecialFieldNumber() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="classInfoQueryForm" id="classInfoQueryForm" action="<%=basePath %>ClassInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="classSpecialFieldNumber">所属专业:</label>
				<input type="text" id="classSpecialFieldNumber" name="classSpecialFieldNumber" value="<%=classSpecialFieldNumber %>" class="form-control" placeholder="请输入所属专业">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="classInfo_classSpecialFieldNumber_edit" class="col-md-3 text-right">所属专业:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="classInfo_classSpecialFieldNumber_edit" name="classInfo.classSpecialFieldNumber" class="form-control" placeholder="请输入所属专业">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (classInfo, response, status) {
			if (classInfo) {
				...
				$("#classInfo_classSpecialFieldNumber_edit").val(classInfo.classSpecialFieldNumber);
