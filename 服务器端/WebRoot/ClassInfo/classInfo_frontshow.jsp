...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>ClassInfo/frontlist">班级信息信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">班级编号:</div>
		<div class="col-md-10 col-xs-6"><%=classInfo.getClassNumber()%></div>
	</div>
	<div class="row bottom15"> 
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=classInfo.getClassSpecialFieldNumber()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">成立日期:</div>
		<div class="col-md-10 col-xs-6"><%=classInfo.getClassBirthDate()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">班主任:</div>
		<div class="col-md-10 col-xs-6"><%=classInfo.getClassTeacherCharge()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">联系电话:</div>
		<div class="col-md-10 col-xs-6"><%=classInfo.getClassTelephone()%></div>
	</div>
	<div class="row bottom15"> 
