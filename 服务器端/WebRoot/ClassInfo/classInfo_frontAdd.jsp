			...
			<div>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="classInfoAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="classInfo_classSpecialFieldNumber" class="col-md-2 text-right">所属专业:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="classInfo_classSpecialFieldNumber" name="classInfo.classSpecialFieldNumber" class="form-control" placeholder="请输入所属专业">
							 </div>
						  </div>
						  <div class="form-group">
...
$(function(){
	...
	$('#classInfoAddForm').bootstrapValidator({
		...
		fields: {
			...
			"classInfo.classSpecialFieldNumber": {
				validators: {
					notEmpty: {
						message: "所属专业不能为空",
					}
