...
<div id="classInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="classInfoQueryForm" method="post">
			...
			所属专业：<input type="text" class="textbox" id="classSpecialFieldNumber" name="classSpecialFieldNumber" style="width:110px" />
...
<div id="classInfoEditDiv">
	<form id="classInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="classInfo_classSpecialFieldNumber_edit" name="classInfo.classSpecialFieldNumber" style="width:200px" />
