		       ...
		       text: "学生选课管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "CourseSelect/courseSelect_add.jsp"
			    	   	},
			    		{
			    	   		text: "学生选课管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "CourseSelect/courseSelect_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "成绩信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "ScoreInfo/scoreInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "成绩信息管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "ScoreInfo/scoreInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻信息管理",
