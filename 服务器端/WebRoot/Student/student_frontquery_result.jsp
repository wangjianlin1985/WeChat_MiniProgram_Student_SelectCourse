...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="studentQueryForm" id="studentQueryForm" action="<%=basePath %>Student/frontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
            	<label for="classObj_classNumber">所在班级：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="student_studentPassword_edit" class="col-md-3 text-right">密码:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="student_studentPassword_edit" name="student.studentPassword" class="form-control" placeholder="请输入密码">
			 </div>
		  </div>
		  <div class="form-group">
